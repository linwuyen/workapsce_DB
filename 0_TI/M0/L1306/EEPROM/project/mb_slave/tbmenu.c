...
int chkValidAddress(uint16_t addr) {
    switch(addr) {
	    ...
	    case _muUARTemueeFSMSTAtus:                                     
	    case _muU32Writesuccess:                                        
	    case _muU8WRiteaction:                                          
	    case _muFGEmueeCONtrol:                                         
	    case _muSTEmueescb:                                             
	    case _muSTEmueespg:                                             
...
uint16_t getModbusData(uint16_t addr) {
    switch(addr) {
	    ...
	    case _muUARTemueeFSMSTAtus: return regMbusData.u16MbusData[6];                            
	    case _muU32Writesuccess: return regMbusData.u16MbusData[7];                            
	    case _muU8WRiteaction: return regMbusData.u16MbusData[8];                            
	    case _muFGEmueeCONtrol: return regMbusData.u16MbusData[9];                            
	    case _muSTEmueescb: return regMbusData.u16MbusData[10];                            
	    case _muSTEmueespg: return regMbusData.u16MbusData[11];                            
...
uint16_t setModbusData(uint16_t addr, uint16_t data) {
    switch(addr) {
	    ...
	    case _muUARTemueeFSMSTAtus: regMbusData.u16MbusData[6] = data; break;                            
	    case _muU32Writesuccess: regMbusData.u16MbusData[7] = data; break;                            
	    case _muU8WRiteaction: regMbusData.u16MbusData[8] = data; break;                            
	    case _muFGEmueeCONtrol: regMbusData.u16MbusData[9] = data; break;                            
	    case _muSTEmueescb: regMbusData.u16MbusData[10] = data; break;                            
	    case _muSTEmueespg: regMbusData.u16MbusData[11] = data; break;                            
