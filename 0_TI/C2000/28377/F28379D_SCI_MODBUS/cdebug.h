...
#define SET_DEBUG_TIME_TASK()           GPIO_writePin(C28_WORK, 1);
#define RST_DEBUG_TIME_TASK()           GPIO_writePin(C28_WORK, 0);
#define TGE_DEBUG_TIME_TASK()           GPIO_togglePin(C28_WORK);

#define SET_DEBUG_ADC_EOC()             GPIO_writePin(C28_ERROR, 1);
#define RST_DEBUG_ADC_EOC()             GPIO_writePin(C28_ERROR, 0);
