...
int main(void)
{
    ...
    printf("\n\nCPU @ %d Hz\n", SystemCoreClock);
    printf("+-------------------------------------------------------+\n");
    printf("|    GPIO Power-Down and Wake-up by PB.7 Sample Code    |\n");
    printf("+-------------------------------------------------------+\n\n");
    ...
    /* Waiting for PB.7 rising-edge interrupt event */
    while(1)
    {
        printf("Enter to Power-Down. Wait PB.7 rising edge interrupt to wake up ...\n");
