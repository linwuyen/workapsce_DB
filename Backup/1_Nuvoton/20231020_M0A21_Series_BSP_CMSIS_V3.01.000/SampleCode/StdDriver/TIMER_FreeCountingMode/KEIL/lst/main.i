...
void TMR0_IRQHandler(void)
{
    ...
    TIMER_ClearCaptureIntFlag(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000)));

    if(cnt == 0)
    {
        t0 = TIMER_GetCaptureData(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000)));
        cnt++;
    }
    else if(cnt == 1)
    {
        t1 = TIMER_GetCaptureData(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000)));
        cnt++;
        if(t0 >= t1)
        {
...
void SYS_Init(void)
{
    ...
    CLK_SetModuleClock(((((1) & 0x03UL) << 30)|((((2)) & 0x1fUL) << 0)| (((1) & 0x03UL) << 28)|(((7) & 0x07UL) << 25)|((((8)) & 0x1fUL) << 20)| (((0x0) & 0x03UL) << 18)|(((0x0) & 0xffUL) << 10)|(((0x0) & 0x1fUL) << 5)), (0x2UL<<(8)), 0);
    ...
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPC_MFP1 = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPC_MFP1 & ~((0xfful << (0)))) |
                    ((0x1AUL<<(0)));
...
int main(void)
{
    ...
    printf("Please connect input source with Timer 0 capture pin PC.4, press any key to continue\n");
    getc((& __stdin));

     
    TIMER_Open(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000)), (1UL << (27)), 1000000);

     
    ((((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000)))->CTL = ((((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000)))->CTL & ~(0xfful << (0))) | (0));

     
    ((((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000)))->CMP = ((0xFFFFFFUL)));

     
    TIMER_EnableCapture(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000)), (0UL << (4)), (1UL << (12)));

     
    TIMER_Start(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000)));

     
    TIMER_EnableCaptureInt(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000)));
