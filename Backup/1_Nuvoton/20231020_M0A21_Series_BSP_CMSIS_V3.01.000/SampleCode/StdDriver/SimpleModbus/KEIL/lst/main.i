...
extern uint32_t rdByte(UART_T * uart);
extern uint32_t DL_UART_transmitData(UART_T *uart,uint8_t u8Data);
# 13 "..\\mb_slave/ModbusCommon.h"
# 1 "..\\mb_slave/..\\g_timer.h"
# 2 "..\\mb_slave/..\\g_timer.h"
# 3 "..\\mb_slave/..\\g_timer.h"

extern uint32_t openTimer(TIMER_T *timer, uint32_t u32Mode, uint32_t u32Freq);

extern uint32_t getTimerCounts(TIMER_T *timer);

# 14 "..\\mb_slave/ModbusCommon.h"
# 1 "..\\mb_slave/CRC16.h"
...
enum {
	_muCLACONtrolSTAtus = 1000,             
	_muCLAERROrSTAtus = 1001,               
	_muENABlePWM = 1002,                    
	_muCONtrolMODe = 1003,                  
	_muVOLtageREFerence = 1004,             
	_muCONstantCURrentREFerence = 1005,     
	_muOVERCURrentPROtection = 1006,        
	_muOVERVOLtagePROtection = 1007,        
	_muFLAshCOUnter0 = 1008,                
	_muFLAshCOUnter1 = 1009,                
    _end_of_1000_id = 9
};
...
void UARTEEPROM(HAL_UART_CALBACK p){
    switch(p->fsm){
            ...
            case _EV_PUSH_SHOW_VALUE_OUT:
                if(p->iTx < p->len){
                    while(0 == isTxFull(((UART_T *) ((( uint32_t)0x40000000) + 0x70000)))) {
											 DL_UART_transmitData(((UART_T *) ((( uint32_t)0x40000000) + 0x70000)), p->buffer[p->iTx++]);
            ...
            case _EV_PUSH_RETURN_CHAR_OUT:
                if(0 == isTxFull(((UART_T *) ((( uint32_t)0x40000000) + 0x70000)))) {
									DL_UART_transmitData(((UART_T *) ((( uint32_t)0x40000000) + 0x70000)),0xD);
...
ST_TIMETASK time_task[] = {
        {task2D5msec,         0,   (16000000/400)},
        {task25msec,          0,   (16000000/40)},
        {0, 0, 0}
};
...
{
    uint32_t delta_t;
    uint32_t u32Cnt = getTimerCounts(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000)));

    if(t->cnt > u32Cnt) {
        delta_t = u32Cnt + 16000000 - t->cnt;
    }
    else {
...
void SYS_Init(void)
{
    ...
    CLK_SetModuleClock(((((1) & 0x03UL) << 30)|((((2)) & 0x1fUL) << 0)| (((1) & 0x03UL) << 28)|(((7) & 0x07UL) << 25)|((((8)) & 0x1fUL) << 20)| (((0x0) & 0x03UL) << 18)|(((0x0) & 0xffUL) << 10)|(((0x0) & 0x1fUL) << 5)), (0x7UL<<(8)), 0);
    ...
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPB_MFP1 = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPB_MFP1 & ~((0xfful << (0)) | (0xfful << (16)))) |                            ((0x08UL<<(0)) | (0x09UL<<(16)));
...
void UART0_Init(void)
{
    ...
    openUart(((UART_T *) ((( uint32_t)0x40000000) + 0x70000)), 115200);
}
...
int32_t main(void)
{
    ...
    openTimer(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000)), (1UL << (27)), 1);
	
		GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0080)), (0x00000080UL), 0x1UL);
