...
void UI2C0_Init(UI2C_T *ui2c, uint32_t u32ClkSpeed)
{
    ...
    UI2C_SetSlaveAddr(ui2c, 0, 0x50, (1U)); 
    UI2C_SetSlaveAddr(ui2c, 1, 0xFF, (0U)); 
    ...
    ((ui2c)->PROTIEN |= (((0x1ul << (6)) | (0x1ul << (3)) | (0x1ul << (2)) | (0x1ul << (1)))));
...
void execI2cSlave(void)
{
    ...
    case _INIT_I2C_CONFIG:
        p->i2c = ((UI2C_T *) ((( uint32_t)0x40000000) + 0xD0000));
        ...
        {stI2cS . fsm = (_CHECK_IS_FLAHS_READY);};;
        break;
    case _CHECK_IS_FLAHS_READY:
        if(isEmuEepromFree()) {
            ...
            {stI2cS . fsm = (_RECEIVE_MEMORY_ADDRESS);};;
        }
        break;
...
void USCI0_IRQHandler(void)
{
    ...
    {				
        ...
        {
					  startcnt = 4;
						uint8_t u8SlaveID = (uint8_t)((((UI2C_T *) ((( uint32_t)0x40000000) + 0xD0000)))->RXDAT);
						
						if ((u32Status & (0x1ul << (15))) == (0x1ul << (15)))
						{
								s_Event = SLAVE_SEND_DATA;   
							  
							 
							  ((((UI2C_T *) ((( uint32_t)0x40000000) + 0xD0000)))->TXDAT = (p->pRAM[p->u32Tcnt++]));
						}
						else
            {
