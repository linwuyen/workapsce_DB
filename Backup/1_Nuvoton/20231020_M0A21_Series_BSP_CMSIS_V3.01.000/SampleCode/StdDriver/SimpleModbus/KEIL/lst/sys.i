...
# 13 "..\\..\\..\\..\\Library\\StdDriver\\src\\sys.c"
...
void SYS_EnableBOD(int32_t i32Mode, uint32_t u32BODLevel)
{
    ...
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->BODCTL = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->BODCTL & ~(0x3ul << (16))) | u32BODLevel;
}
...
void SYS_SetVRef(uint32_t u32VRefCTL)
{
    ...
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->VREFCTL = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->VREFCTL & (~(0xful << (0)))) | (u32VRefCTL);
}
