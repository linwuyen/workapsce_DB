# 1 "..\\..\\..\\..\\Library\\StdDriver\\src\\timer.c"
...
# 13 "..\\..\\..\\..\\Library\\StdDriver\\src\\timer.c"
...
{
    uint32_t u32Src;
    const uint32_t au32Clk[] = {(12000000UL), (32768UL), 0, 0, 0, (38400UL), 0, (48000000UL)};
...
void TIMER_SetTriggerTarget(TIMER_T *timer, uint32_t u32Mask)
{
    timer->CTL = (timer->CTL & ~((0x1ul << (19)) | (0x1ul << (20)) | (0x1ul << (21)) | (0x1ul << (8)))) | (u32Mask);
}
