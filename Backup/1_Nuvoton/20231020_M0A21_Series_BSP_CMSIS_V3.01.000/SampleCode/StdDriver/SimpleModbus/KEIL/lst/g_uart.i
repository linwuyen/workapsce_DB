...
uint32_t openUart(UART_T *uart, uint32_t u32baudrate)
{
    ...
    uint32_t u32ClkTbl[6ul] = {(12000000UL), 0ul, (32768UL), (48000000UL), 0ul, (38400UL)};
...
{	
	return ((uart)->FIFOSTS & (0x1ul << (14)));   
}

uint32_t isTxFull(UART_T *uart)
{
	return (((uart)->FIFOSTS & (0x1ul << (23)))>>(23));
}

uint32_t wrBytes(UART_T * uart, uint8_t *pu8TxBuf, uint32_t u32Count)
{
	int16_t i = 0;
	for(i=0; i<u32Count; i++) uart->DAT = pu8TxBuf[i];     
