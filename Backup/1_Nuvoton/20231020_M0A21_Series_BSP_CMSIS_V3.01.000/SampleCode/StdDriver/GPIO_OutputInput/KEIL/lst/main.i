...
int32_t main(void)
{
    ...
    printf("+-------------------------------------------------+\n");
    printf("|    PB.7(Output) and PC.1(Input) Sample Code     |\n");
    printf("+-------------------------------------------------+\n\n");

     
     
     
    printf("  >> Please connect PB.7 and PC.1 first << \n");
    printf("     Press any key to start test by using [Pin Data Input/Output Control] \n\n");
    getc((& __stdin));

     
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0040)), (0x00000080UL), 0x1UL);
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0080)), (0x00000002UL), 0x0UL);

    i32Err = 0;
    printf("GPIO PB.7 (output mode) connect to PC.1 (input mode) ......");
    ...
    while((*((volatile uint32_t *)(((((( uint32_t)0x40000000) + 0x4000) + 0x0800)+(0x40*(2))) + ((1)<<2)))) != 0)
    {
        if(i32TimeOutCnt > 0)
        {
            i32TimeOutCnt--;
    ...
    while((*((volatile uint32_t *)(((((( uint32_t)0x40000000) + 0x4000) + 0x0800)+(0x40*(2))) + ((1)<<2)))) != 1)
    {
        if(i32TimeOutCnt > 0)
        {
            i32TimeOutCnt--;
    ...
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0040)), (0x00000080UL), 0x3UL);
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0080)), (0x00000002UL), 0x3UL);
