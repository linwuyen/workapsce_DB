...
int main(void)
{
    ...
    printf("    USCI_SPI0_SS(PC.7)   <--> USCI_SPI1_SS(PC.3)\n    USCI_SPI0_CLK(PC.6)  <--> USCI_SPI1_CLK(PC.2)\n");
    printf("    USCI_SPI0_MISO(PC.4) <--> USCI_SPI1_MISO(PC.0)\n    USCI_SPI0_MOSI(PC.5) <--> USCI_SPI1_MOSI(PC.1)\n\n");
...
void SYS_Init(void)
{
    ...
    SYS->GPC_MFP0 = (SYS->GPC_MFP0 & ~(SYS_GPC_MFP0_PC0MFP_Msk | SYS_GPC_MFP0_PC1MFP_Msk | SYS_GPC_MFP0_PC2MFP_Msk | SYS_GPC_MFP0_PC3MFP_Msk)) |
                    (SYS_GPC_MFP0_PC0MFP_USCI1_DAT1 | SYS_GPC_MFP0_PC1MFP_USCI1_DAT0 | SYS_GPC_MFP0_PC2MFP_USCI1_CLK | SYS_GPC_MFP0_PC3MFP_USCI1_CTL0);
