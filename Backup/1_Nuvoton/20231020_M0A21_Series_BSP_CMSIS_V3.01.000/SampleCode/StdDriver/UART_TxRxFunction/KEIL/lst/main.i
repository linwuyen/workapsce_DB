...
void UART_TEST_HANDLE()
{
    ...
    if ((((((UART_T *) ((( uint32_t)0x40000000) + 0x70000)))->INTSTS & ((0x1ul << (8))))?1:0))
    {
        printf("\nInput:");

         
        while((((((UART_T *) ((( uint32_t)0x40000000) + 0x70000)))->INTSTS & (0x1ul << (0)))>>(0)))
        {
             
            u8InChar = ((((UART_T *) ((( uint32_t)0x40000000) + 0x70000)))->DAT);
    ...
    if((((((UART_T *) ((( uint32_t)0x40000000) + 0x70000)))->INTSTS & ((0x1ul << (9))))?1:0))
    {
        uint16_t tmp;
        tmp = g_u32comRtail;
        if(g_u32comRhead != tmp)
        {
            ...
            while((((((UART_T *) ((( uint32_t)0x40000000) + 0x70000)))->FIFOSTS & (0x1ul << (23)))>>(23)));   
            ((((UART_T *) ((( uint32_t)0x40000000) + 0x70000)))->DAT = (u8InChar));
            g_u32comRhead = (g_u32comRhead == (256 - 1)) ? 0 : (g_u32comRhead + 1);
            g_u32comRbytes--;
        }
    }

    if(((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->FIFOSTS & ((0x1ul << (6)) | (0x1ul << (5)) | (0x1ul << (4)) | (0x1ul << (0))))
    {
        UART_ClearIntFlag(((UART_T *) ((( uint32_t)0x40000000) + 0x70000)), ((0x1ul << (10))| (0x1ul << (13))));
    }
}
...
void UART_FunctionTest()
{
    ...
    UART_EnableInt(((UART_T *) ((( uint32_t)0x40000000) + 0x70000)), ((0x1ul << (0)) | (0x1ul << (1))));
    while(g_bWait);

     
    UART_DisableInt(((UART_T *) ((( uint32_t)0x40000000) + 0x70000)), ((0x1ul << (0)) | (0x1ul << (1))));
    g_bWait = (1UL);
