...
void initClaCtrlParam(void)
{
    ...
    sCLA.sLoopI.f32Min = -1.0f;
    sCLA.sLoopI.f32Max = 1.0f;
    sCLA.sLoopI.f32Itemp = 0.0f;
    sCLA.sLoopI.f32Out = 0.0f;
    sCLA.sLoopI.u16StopUi = false;

    sCLA.f32IrefLimitP = RATED_IOUT_P_PU;
    sCLA.f32IrefLimitN = RATED_IOUT_N_PU;

    sCLA.f32Ovp = OVP_PU;
    sCLA.f32Ocp = OCP_PU;
    sCLA.f32ELOcp = EL_OCP_PU;
    sCLA.f32ELVon = EL_Von_PU;
    sCLA.f32VinOvp = VIN_OVP_PU;

    sCLA.sHRPWM.u32PwmBase = EPWM1_BASE;
    sCLA.sHRPWM.u32PwmA = 0;
    sCLA.sHRPWM.u32PwmB = 0;
